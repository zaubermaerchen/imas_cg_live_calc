...
a=8==c?[new Damage("TP1"),new Damage("TP2"),new Damage("TP3")]:[new Damage("通常"),new Damage("全力")];for(var o=0,p=0,q=0,r=0,s=0;s<this.idol_list.length;s++){var t=this.idol_list[s],u=l>s;switch(c){case 5:t.calculation_dream_live_festival(u,d,this.appeal_bonus,h,j,i),a[0].add_damage(t.calc_dream_live_festival_damage(!1)),a[1].add_damage(t.calc_dream_live_festival_damage(!0));break;case 8:t.calculation_talk_battle(u,d,this.appeal_bonus,h,k,i);for(var v=t.calc_talk_battle_damage(!1),w=0;w<a.length;w++)a[w].add_damage(v*b.USE_POINT_COEFFICIENT[w]);break;default:t.calculation_live_tour(u,d,this.appeal_bonus,e,f,g,i),a[0].add_damage(t.calc_live_tour_damage(!1)),a[1].add_damage(t.calc_live_tour_damage(!0))}var x=t.actual_offense,y=t.actual_defense;u?(o+=x,p+=y):(q+=x,r+=y),m+=x,n+=y,t.style="numeric "+(u?"front":"back")}this.front_offense=Math.ceil(o),this.front_defense=Math.ceil(p),this.back_offense=Math.ceil(q),this.back_defense=Math.ceil(r);var z=this.calculation_petit_idol();switch(c){case 5:a[0].add_bonus(Math.floor(z*UserIdol.DREAM_LIVE_FESTIVAL_NORMAL_LIVE_COEFFICIENT/5)),a[1].add_bonus(Math.floor(z*UserIdol.DREAM_LIVE_FESTIVAL_FULL_POWER_LIVE_COEFFICIENT/5));break;case 8:for(var s=0;s<a.length;s++)a[s].add_bonus(Math.ceil(z*b.USE_POINT_COEFFICIENT[s]/5));break;default:a[0].add_bonus(Math.floor(z*UserIdol.LIVE_TOUR_NORMAL_LIVE_COEFFICIENT/5)),a[1].add_bonus(Math.floor(z*UserIdol.LIVE_TOUR_FULL_POWER_LIVE_COEFFICIENT/5))}return m+=z,n+=z,this.petit_idol_total_status=z,this.damage_list=a,[Math.ceil(m),Math.ceil(n)]},b.prototype.calculation_petit_idol=function(){for(var a=parseInt(this.calc_type),b=parseInt(this.petit_idol_bonus_type),c=parseInt(this.petit_idol_bonus_parameter),d=parseInt(this.voltage_bonus),e=parseInt(this.fever_bonus),f=parseInt(this.cheer_bonus),g=0,h=0;h<this.petit_idol_list.length;h++){var i=this.petit_idol_list[h];switch(a){case 5:i.calculation_dream_live_festival(e);break;case 8:i.calculation_talk_battle(b,f);break;default:i.calculation_live_tour(c,d)}g+=i.status}return Math.ceil(g)},b.prototype.get_setting=function(){var b=a.prototype.get_setting.call(this);return b.voltage_bonus=this.voltage_bonus,b.status_up=this.status_up,b.compatibility_type=this.compatibility_type,b.combo_level=this.combo_level,b.fever_bonus=this.fever_bonus,b.cheer_bonus=this.cheer_bonus,b},b.prototype.set_setting=function(b){a.prototype.set_setting.call(this,b),b.voltage_bonus&&(this.voltage_bonus=b.voltage_bonus),this.status_up=b.status_up,this.compatibility_type=b.compatibility_type,this.combo_level=b.combo_level,this.fever_bonus=b.fever_bonus,b.cheer_bonus&&(this.cheer_bonus=b.cheer_bonus)},b.prototype.check_target_own_unit_skill_enable=function(a,b,c,d){var e=parseInt(this.enable_skill_type),f=parseInt(a.target_param),g=parseInt(a.target_member),h=parseInt(a.target_type);return 0!=e&&0!=f&&e!=f?null:0==g?(this.is_dream_live_festival()||this.apply_skill_effect(c,a,d),a):this.check_skill_target(g,h,b)?a:null},b.prototype.apply_skill_value=function(b,c,d){if(!this.is_talk_battle())return a.prototype.apply_skill_value.call(this,b,c,d);var e=!1,f=parseFloat(b.offense_skill),g=parseFloat(b.defense_skill);switch(d=1+d/100,f=1+f/100,g=1+g/100,c){case 0:f*=d,g*=d,e=!0;break;case 1:f*=d,e=!0;break;case 2:g*=d,e=!0}return f=100*(f-1),g=100*(g-1),b.offense_skill=f.toString(),b.defense_skill=g.toString(),e},b.USE_POINT_COEFFICIENT=[1,2.5,5],b}(BaseLiveTourCalcViewModel);jQuery(function(){ko.applyBindings(new ViewModel)});