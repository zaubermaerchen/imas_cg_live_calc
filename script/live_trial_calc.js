...
var ViewModel = (function (_super) {
    ...
    ViewModel.prototype.calculation = function () {
        ...
        var cost_cut = (this.total_cost() > 0);
    ...
    ViewModel.prototype.sort_idol = function () {
        if (this.auto_sort()) {
            var untarget_idol_list = this.idol_list().slice(0, this.front_num());
            var target_idol_list = this.idol_list().slice(this.front_num());
...
//# sourceMappingURL=live_trial_calc.js.map
