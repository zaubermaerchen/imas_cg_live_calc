...
var ViewModel = (function (_super) {
    ...
    function ViewModel() {
        ...
        // 定数
        // バトルポイント係数
        this.BATTLE_POINT_RATE_LIST = [0.8, 1, 1.5, 2, 2.5];
        this.GUEST_BATTLE_POINT_RATE_LIST = [0.5, 1, 1.6, 2.25, 3];
        // セーブデータ関係
    ...
    ViewModel.prototype.calculation = function () {
        ...
        var battle_point_rate = this.BATTLE_POINT_RATE_LIST[battle_point - 1];
        ...
        for (var i = 0; i < this.idol_list().length; i++) {
            ...
            // 与ダメージ計算
            if (is_guest_live) {
                var damage = idol.calc_live_royal_damage();
