...
var ViewModel = (function (_super) {
    ...
    function ViewModel() {
        ...
        this.USE_CP_COEFFICIENT = {
            "CP1": 1,
            "CP2": 2.5,
            "CP3": 5
        };
        this.SCORE_OFFSET = 2000;
    ...
    ViewModel.prototype.calculation = function () {
        ...
        for (var i = 0; i < this.idol_list().length; i++) {
            ...
            for (var key in this.USE_CP_COEFFICIENT) {
                var _score = score * this.USE_CP_COEFFICIENT[key];
    ...
    ViewModel.prototype.set_idol_setting = function (settings, max_num, use_tour_skill) {
        var deferred = jQuery.Deferred();
        var objects = {};
        for (var i = 0; i < settings.length; i++) {
            var key = "t" + settings[i]["type"] + "_r" + settings[i]["rarity"];
...
//# sourceMappingURL=challenge_calc.js.map
