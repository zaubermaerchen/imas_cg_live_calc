...
var ViewModel = (function (_super) {
    ...
    ViewModel.prototype.is_festival = function () {
        return (parseInt(this.calc_type()) == 2 /* FESTIVAL */);
    };
    ViewModel.prototype.is_festivalS = function () {
        return (parseInt(this.calc_type()) == 10 /* FESTIVAL_S */);
    };
    ...
    ViewModel.prototype.calculation = function () {
        ...
        var groove_type = parseInt(this.groove_type());
        ...
        var rest_cost = Math.floor(parseInt(this.total_cost()) * ratio);
    ...
    ViewModel.prototype.sort_idol = function () {
        ...
        if (this.auto_sort()) {
            ...
            target_idol_list.sort(function (a, b) {
                ...
                // ソート条件ステータスを設定
                var a_ratio = parseFloat(a.offense_per_cost());
                var a_value = parseInt(a.offense());
                var b_ratio = parseFloat(b.offense_per_cost());
