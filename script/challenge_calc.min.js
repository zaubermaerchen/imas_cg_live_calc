...
o.style="numeric "+(p?"front":"back")}this.front_offense=Math.ceil(i),this.front_defense=Math.ceil(j),this.back_offense=Math.ceil(k),this.back_defense=Math.ceil(l);for(var u=this.calculation_petit_idol(),n=0;n<m.length;n++)m[n].add_bonus(Math.ceil(u*b.USE_POINT_COEFFICIENT[n]/5));return g+=u,h+=u,this.petit_idol_total_status=u,this.damage_list=m,[Math.ceil(g),Math.ceil(h)]},b.prototype.calculation_petit_idol=function(){for(var a=parseInt(this.petit_idol_bonus_type),b=parseInt(this.fever_bonus),c=0,d=0;d<this.petit_idol_list.length;d++){var e=this.petit_idol_list[d];e.calculation_challenge(a,b),c+=e.status}return Math.ceil(c)},b.prototype.get_setting=function(){var b=a.prototype.get_setting.call(this);return b.unit_type=this.unit_type,b.fever_bonus=this.fever_bonus,b.petit_idol_bonus_type=this.petit_idol_bonus_type,b},b.prototype.set_setting=function(b){a.prototype.set_setting.call(this,b),this.unit_type=b.unit_type,this.fever_bonus=b.fever_bonus,this.petit_idol_bonus_type=b.petit_idol_bonus_type},b.prototype.apply_skill_value=function(a,b,c){var d=!1,e=parseFloat(a.offense_skill),f=parseFloat(a.defense_skill);switch(c=1+c/100,e=1+e/100,f=1+f/100,b){case 0:e*=c,f*=c,d=!0;break;case 1:e*=c,d=!0;break;case 2:f*=c,d=!0}return e=100*(e-1),f=100*(f-1),a.offense_skill=e.toString(),a.defense_skill=f.toString(),d},b.USE_POINT_COEFFICIENT=[1,2.5,5],b.SCORE_OFFSET=2e3,b}(BaseLiveTourCalcViewModel);jQuery(function(){ko.applyBindings(new ViewModel)});
